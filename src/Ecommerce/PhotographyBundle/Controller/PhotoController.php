...
use Ecommerce\PhotographyBundle\Entity\Photo;
use Ecommerce\PhotographyBundle\Form\PhotoType;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EcommercePhotographyBundle:Photo')->findAll();

        return $this->render('EcommercePhotographyBundle:Photo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EcommercePhotographyBundle:Photo:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EcommercePhotographyBundle:Photo')->find($id);
        ...
        return $this->render('EcommercePhotographyBundle:Photo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcommercePhotographyBundle:Photo:edit.html.twig', array(
            'entity'      => $entity,
